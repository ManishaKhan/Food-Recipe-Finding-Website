...
const RecipeDetail = () => {
  ...
  return (
    <div className="recipe-detail pt-24 bg-black min-h-screen text-white">
      <Link to="/recipes" className="back-button">
        ← Back to explore more recipes
      </Link>
      ...
      <div className="recipe-hero">
        ...
        <div className="detail-info">
          ...
          <div className="ingredients-section">
            <h2 className="recipeDeatilsHeader">Ingredients</h2>
      ...
      <div className="instructions-section">
        <h2 className="recipeDeatilsHeader">Instructions</h2>
      ...
      {recipe.strYoutube && (
        <div className="video-section">
          <h2 className="recipeDeatilsHeader">Video Tutorial</h2>
